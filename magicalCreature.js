...
let creatureDescription ='a mythical creature that flies and breathes fire';
...
let zooSummary='The '+creatureName+' is '+creatureDescription+ ". The fact that it is friendly to humans is "+isFriendly+ ". The age restriction is "+visitorAge+ " and the fact that you can visit is " +canVisit;
